...
const Final = () => {
    ...
    const initialState = {
        ...
        isEditing:{status: false, id: '', namee: '', email:''}, 
    }
    ...
    <div>
      ...
      comingTitle={state.isEditing.name} comingtEmail={state.isEditing.email}
...
const EditFormContainer = ({id, comingTitle, comingtEmail, updateData}) => {

    const [title, setTitle] = useState(comingTitle || '');
    const [email, setEmail] = useState(comingtEmail || '');
